...
export default class SpeedController {
  ...
  _handlePlaybackRateChangeError() {
    ...
    if (this.skipper.element.playbackRate !== 0) {
      ...
      if (!this._rateChangeListenerAdded) {
        ...
        this.skipper.element.addEventListener(
          'ratechange',
          (event: Event) => {
            if (this._blockRateChangeEvents) {
              ...
              if (
                ...
                this.skipper.element.playbackRate ===
                  this.skipper.element.defaultPlaybackRate &&
  ...
  setPlaybackRate(rate: number) {
    ...
    if (this.skipper.preloadElement) {
      this.skipper.preloadElement.playbackRate = this._targetPlaybackRate;
    }
